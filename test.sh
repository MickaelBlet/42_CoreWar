...
#    Updated: 2016/10/23 12:29:06 by mblet            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
champions/corewar/corewar \
	-v 4 \
	-d $dump \
	$champion1 $champion2 $champion3 $champion4 > test_dump_zaz

./corewar \
	--ops \
	-d $dump \
	$champion1 $champion2 $champion3 $champion4 > test_dump_me

diff -s --speed-large-files test_dump_zaz test_dump_me | sed "s/^</me :/" | sed "s/^>/zaz:/"
